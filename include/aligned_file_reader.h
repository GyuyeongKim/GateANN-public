...
class AlignedFileReader {
  ...
  */
  ...
  // Returns number of unconsumed CQ entries (non-destructive, no syscall).
  // Used by eager cache to detect IO completions during processing.
  virtual unsigned cq_ready(void *ctx) { return 0; }
